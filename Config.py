...
config['PFT'] = {}
config['PFT']['Invoke_URL'] = _crypt.encrypt('https://1846704f86f048c88eef33c8c6f25bf9.apigw.ntruss.com/custom/v1/9283/31ef3d7299496acfc1851b8e73dc7b1a29ff5ada752259ba49a64ce0cb393af1/infer')
config['PFT']['secret_key'] = _crypt.encrypt('RFRESE5ycld5UnJaa3NnQm5TVnNCdXB0SFZib1ZSTFU=')

config['PWV'] = {}
config['PWV']['Invoke_URL'] = _crypt.encrypt('https://1846704f86f048c88eef33c8c6f25bf9.apigw.ntruss.com/custom/v1/9284/41486255f694d57f2071bb9626a279a53c21ddc60fae1fdc26ceb3cfc8efb79e/infer')
config['PWV']['secret_key'] = _crypt.encrypt('VFZmWUR1VkNtbmx6Q2N0aHN3QVVhRHlTcElvclBIaUY=')

config['DataBase'] = {}
config['DataBase']['DSNNAME'] = _crypt.encrypt('KUMC_CDW')
config['DataBase']['DBUSER'] = _crypt.encrypt('sys')
config['DataBase']['DBPWD'] = _crypt.encrypt('admin06##')
